...
def train(model, data, params):
    ...
    log.put("The original number of training utterances:\t"
    ...
    log.put(
        "The actual number of used training examples:\t" +
        str(num_train_examples))
    log.put("(Shortened by output limit of " +
            str(maximum_output_length) +
            ")")
    log.put("The number of steps per epoch:\t" + str(num_steps_per_epoch))
...
def main():
    ...
    if params.interaction_level:
        ...
        print('The model has not been implemented')
        exit()
